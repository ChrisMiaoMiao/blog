                ...
                <div className="post-main">
                    ...
                    <div className="mt-3">
                        ...
                        <div>
                          ...
                          <p className="d-inline-block ml-3 w-75 align-top"><span role="img" aria-label="徒手健身">🏊</span>徒手健身者，目前基于囚徒健身体系进行身体锻炼。</p>
                        </div>
                        <div>
                          <span className="text-success d-inline-block" title="prism">
                            <FaCheckCircle size={26} style={{ color: "success" }} />
                          </span>
                          <p className="d-inline-block ml-3 w-75 align-top"><span role="img" aria-label="冥想">🧘‍♂️</span>正念践行者，追求内心世界的平静。</p>
                        </div>
                        <div>
                          <span className="text-success d-inline-block" title="prism">
                            <FaCheckCircle size={26} style={{ color: "success" }} />
                          </span>
                          <p className="d-inline-block ml-3 w-75 align-top"><span role="img" aria-label="晨间日记">📓</span>晨间日记践行者，4年积累1000篇日记</p>
                        </div>
                        <h4>正在做的事:</h4>
                        <div>
